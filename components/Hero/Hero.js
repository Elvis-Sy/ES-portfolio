...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="home"
      className="w-full flex md:items-center pt-4 pb-6 md:py-8 2xl:container mx-auto xl:px-20 md:px-12 px-4 md:min-h-screen relative mb-24"
      style={{ opacity: 0 }}
    >
      <style global jsx>
        {`
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          ...
          <span className="staggered-reveal"> Sylvano</span>
        </h1>
        <p>
          <span
            ref={typedElementRef}
